...
from workshop.part2.core.model import ConditionalTransformer, MotionAutoencoder
from workshop.part2.core.model import joint_limit_loss
from workshop.part2.core.model import encode_in_batches
from workshop.part3.config import ACTION_PHASES, OUT, PriorConfig
from workshop.part3.data.contract import DATASET_VARIANT, DEFAULT_ROOT
from workshop.part3.data.loader import load_manifest, load_split
from workshop.part3.core.model import FeedbackActionDecoder, pre_tanh, tanh_gaussian_nll
from workshop.part3.core.model import StateActionWindows, state_action_windows
...
def main() -> None:
    ...
    print(
        f"Part 3 data train={len(train.features):,} validation={len(validation.features):,} "
        f"device={DEVICE}",
        flush=True,
    )
    ...
    checkpoint = {
        "schema": "workshop-part3-prior-v1",
