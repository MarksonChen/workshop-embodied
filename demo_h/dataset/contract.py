"""Public schema and temporal semantics for the Demo H derived dataset."""
...
from demo_h.config import ACTION_DIM, CLIP_FRAMES, STATE_DIM, TRANSITIONS
...
# u[t] acts during [t, t + 1) and produces realized state[t + 1].
FIELDS = {
